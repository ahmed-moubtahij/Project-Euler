...
int main()
{
  ...
  constexpr auto expected_pythagorean_sum = [](auto const common_tuple)
  {
  ...
  constexpr auto fold_multiply = [](std::same_as<int> auto const ...is)
  { return (is * ... * 1); };

  constexpr auto tuple_fold = [fold_multiply](auto const common_tuple)
